...
public sealed class Cartridge
{
    ...
    public void WriteRom(ushort address, byte value)
    {
        switch (Kind)
        {
            case MapperKind.Mbc1:
                ...
                break;
            case MapperKind.Mbc3:
                Mbc3.WriteRom(this, address, value);
                break;
            case MapperKind.Mbc5:
                Mbc5.WriteRom(this, address, value);
                break;
        }
    }
    ...
    public void WriteRam(ushort address, byte value)
    {
        switch (Kind)
        {
            case MapperKind.Mbc1:
                ...
                break;
            case MapperKind.Mbc3:
                Mbc3.WriteRam(this, address, value);
                break;
            case MapperKind.Mbc5:
                Mbc5.WriteRam(this, address, value);
                break;
        }
    }
    ...
    public void ReadState(StateReader r)
    {
        ...
        if (ramLen != Ram.Length)
            throw new InvalidDataException("cartridge RAM size mismatch");
        if (ramLen > 0)
            r.ReadBytes(Ram.AsSpan());
