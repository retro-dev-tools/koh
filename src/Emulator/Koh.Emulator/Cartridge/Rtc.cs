...
namespace Koh.Emulator.Cartridge;
...
public struct Rtc
{
    ...
    public void WriteState(StateWriter w)
    {
        ...
        w.WriteByte(Hours);
        w.WriteByte(DayLow);
        w.WriteByte(DayHighAndFlags);
        w.WriteByte(LatchedSeconds);
        w.WriteByte(LatchedMinutes);
        w.WriteByte(LatchedHours);
        w.WriteByte(LatchedDayLow);
        w.WriteByte(LatchedDayHighAndFlags);
    ...
    public void ReadState(StateReader r)
    {
        ...
        Hours = r.ReadByte();
        DayLow = r.ReadByte();
        DayHighAndFlags = r.ReadByte();
        LatchedSeconds = r.ReadByte();
        LatchedMinutes = r.ReadByte();
        LatchedHours = r.ReadByte();
        LatchedDayLow = r.ReadByte();
        LatchedDayHighAndFlags = r.ReadByte();
