...
public static class InstructionTable
{
    ...
    private static byte ReadReg8(ref CpuRegisters r, IInstructionBus bus, int idx) =>
        idx switch
        {
            0 => r.B,
            1 => r.C,
    ...
    private static bool TestCond(ref CpuRegisters r, int cond) =>
        cond switch
        {
    ...
    private static InstructionHandler?[] BuildUnprefixedTable()
    {
        ...
        // LD rr,d16
        t[0x01] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.BC = bus.ReadImmediate16();
            return 12;
        };
        t[0x11] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.DE = bus.ReadImmediate16();
            return 12;
        };
        t[0x21] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.HL = bus.ReadImmediate16();
            return 12;
        };
        t[0x31] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Sp = bus.ReadImmediate16();
            return 12;
        };

        // LD (rr),A / LD A,(rr)
        t[0x02] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(r.BC, r.A);
            return 8;
        };
        t[0x12] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(r.DE, r.A);
            return 8;
        };
        t[0x0A] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte(r.BC);
            return 8;
        };
        t[0x1A] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte(r.DE);
            return 8;
        };
        t[0x22] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(r.HL, r.A);
            r.HL = (ushort)(r.HL + 1);
            return 8;
        };
        t[0x32] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(r.HL, r.A);
            r.HL = (ushort)(r.HL - 1);
            return 8;
        };
        t[0x2A] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte(r.HL);
            r.HL = (ushort)(r.HL + 1);
            return 8;
        };
        t[0x3A] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte(r.HL);
            r.HL = (ushort)(r.HL - 1);
            return 8;
        ...
        t[0x03] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.BC = (ushort)(r.BC + 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x13] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.DE = (ushort)(r.DE + 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x23] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.HL = (ushort)(r.HL + 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x33] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Sp = (ushort)(r.Sp + 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x0B] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.BC = (ushort)(r.BC - 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x1B] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.DE = (ushort)(r.DE - 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x2B] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.HL = (ushort)(r.HL - 1);
            bus.InternalCycle();
            return 8;
        };
        t[0x3B] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Sp = (ushort)(r.Sp - 1);
            bus.InternalCycle();
            return 8;
        ...
        t[0x04] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.B = AluInc(ref r, r.B);
            return 4;
        };
        t[0x0C] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.C = AluInc(ref r, r.C);
            return 4;
        };
        t[0x14] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.D = AluInc(ref r, r.D);
            return 4;
        };
        t[0x1C] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.E = AluInc(ref r, r.E);
            return 4;
        };
        t[0x24] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.H = AluInc(ref r, r.H);
            return 4;
        };
        t[0x2C] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.L = AluInc(ref r, r.L);
            return 4;
        };
        t[0x34] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            byte v = AluInc(ref r, bus.ReadByte(r.HL));
            bus.WriteByte(r.HL, v);
            return 12;
        };
        t[0x3C] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = AluInc(ref r, r.A);
            return 4;
        };

        t[0x05] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.B = AluDec(ref r, r.B);
            return 4;
        };
        t[0x0D] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.C = AluDec(ref r, r.C);
            return 4;
        };
        t[0x15] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.D = AluDec(ref r, r.D);
            return 4;
        };
        t[0x1D] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.E = AluDec(ref r, r.E);
            return 4;
        };
        t[0x25] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.H = AluDec(ref r, r.H);
            return 4;
        };
        t[0x2D] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.L = AluDec(ref r, r.L);
            return 4;
        };
        t[0x35] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            byte v = AluDec(ref r, bus.ReadByte(r.HL));
            bus.WriteByte(r.HL, v);
            return 12;
        };
        t[0x3D] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = AluDec(ref r, r.A);
            return 4;
        };

        // LD r,d8
        t[0x06] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.B = bus.ReadImmediate();
            return 8;
        };
        t[0x0E] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.C = bus.ReadImmediate();
            return 8;
        };
        t[0x16] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.D = bus.ReadImmediate();
            return 8;
        };
        t[0x1E] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.E = bus.ReadImmediate();
            return 8;
        };
        t[0x26] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.H = bus.ReadImmediate();
            return 8;
        };
        t[0x2E] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.L = bus.ReadImmediate();
            return 8;
        };
        t[0x36] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(r.HL, bus.ReadImmediate());
            return 12;
        };
        t[0x3E] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadImmediate();
            return 8;
        };
        ...
        t[0x09] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAddHl(ref r, r.BC);
            bus.InternalCycle();
            return 8;
        };
        t[0x19] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAddHl(ref r, r.DE);
            bus.InternalCycle();
            return 8;
        };
        t[0x29] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAddHl(ref r, r.HL);
            bus.InternalCycle();
            return 8;
        };
        t[0x39] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAddHl(ref r, r.Sp);
            bus.InternalCycle();
            return 8;
        ...
        t[0x10] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.ReadImmediate();
            bus.Stop();
            return 4;
        ...
        t[0x27] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            ...
            {
                if (r.FlagSet(CpuRegisters.FlagC) || a > 0x99)
                {
                    a += 0x60;
                    r.SetFlag(CpuRegisters.FlagC, true);
                }
                if (r.FlagSet(CpuRegisters.FlagH) || (a & 0x0F) > 0x09)
                {
                    a += 0x06;
                }
            }
            ...
            {
                if (r.FlagSet(CpuRegisters.FlagC))
                    a -= 0x60;
                if (r.FlagSet(CpuRegisters.FlagH))
                    a -= 0x06;
            }
            r.A = (byte)a;
            r.SetFlag(CpuRegisters.FlagZ, r.A == 0);
        ...
        for (int op = 0x40; op <= 0x7F; op++)
        {
            if (op == 0x76)
            {
                t[op] = (ref CpuRegisters r, IInstructionBus bus) =>
                {
                    bus.Halt();
                    return 4;
                };
        ...
        for (int op = 0x80; op <= 0xBF; op++)
        {
            ...
            t[opCap] = (ref CpuRegisters r, IInstructionBus bus) =>
            {
                ...
                {
                    case 0:
                        AluAdd(ref r, v, false);
                        break;
                    case 1:
                        AluAdd(ref r, v, true);
                        break;
                    case 2:
                        AluSub(ref r, v, false, true);
                        break;
                    case 3:
                        AluSub(ref r, v, true, true);
                        break;
                    case 4:
                        AluAnd(ref r, v);
                        break;
        ...
        t[0xC1] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.BC = Pop16(ref r, bus);
            return 12;
        };
        t[0xD1] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.DE = Pop16(ref r, bus);
            return 12;
        };
        t[0xE1] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.HL = Pop16(ref r, bus);
            return 12;
        };
        t[0xF1] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.AF = Pop16(ref r, bus);
            return 12;
        };

        // PUSH rr — 4 M-cycles: fetch + 1 internal (SP dec) + 2 writes.
        t[0xC5] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.InternalCycle();
            Push16(ref r, bus, r.BC);
            return 16;
        };
        t[0xD5] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.InternalCycle();
            Push16(ref r, bus, r.DE);
            return 16;
        };
        t[0xE5] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.InternalCycle();
            Push16(ref r, bus, r.HL);
            return 16;
        };
        t[0xF5] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.InternalCycle();
            Push16(ref r, bus, r.AF);
            return 16;
        };
        ...
        t[0xC3] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
        ...
        t[0xCD] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            ushort target = bus.ReadImmediate16();
            bus.InternalCycle();
            Push16(ref r, bus, r.Pc);
        ...
        t[0xC9] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Pc = Pop16(ref r, bus);
            bus.InternalCycle();
            return 16;
        ...
        t[0xD9] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Pc = Pop16(ref r, bus);
            bus.InternalCycle();
            bus.SetIme(true);
        ...
        // ALU A,d8
        t[0xC6] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAdd(ref r, bus.ReadImmediate(), false);
            return 8;
        };
        t[0xCE] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAdd(ref r, bus.ReadImmediate(), true);
            return 8;
        };
        t[0xD6] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluSub(ref r, bus.ReadImmediate(), false, true);
            return 8;
        };
        t[0xDE] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluSub(ref r, bus.ReadImmediate(), true, true);
            return 8;
        };
        t[0xE6] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluAnd(ref r, bus.ReadImmediate());
            return 8;
        };
        t[0xEE] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluXor(ref r, bus.ReadImmediate());
            return 8;
        };
        t[0xF6] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluOr(ref r, bus.ReadImmediate());
            return 8;
        };
        t[0xFE] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            AluSub(ref r, bus.ReadImmediate(), false, false);
            return 8;
        };

        // LDH ($FF00+n),A / LDH A,($FF00+n)
        t[0xE0] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte((ushort)(0xFF00 | bus.ReadImmediate()), r.A);
            return 12;
        };
        t[0xF0] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte((ushort)(0xFF00 | bus.ReadImmediate()));
            return 12;
        };

        // LD ($FF00+C),A / LD A,($FF00+C)
        t[0xE2] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte((ushort)(0xFF00 | r.C), r.A);
            return 8;
        };
        t[0xF2] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte((ushort)(0xFF00 | r.C));
            return 8;
        };
        ...
        // JP (HL)
        t[0xE9] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Pc = r.HL;
            return 4;
        };
        ...
        // LD (a16),A / LD A,(a16)
        t[0xEA] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.WriteByte(bus.ReadImmediate16(), r.A);
            return 16;
        };
        t[0xFA] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.A = bus.ReadByte(bus.ReadImmediate16());
            return 16;
        };
        ...
        t[0xF9] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            r.Sp = r.HL;
            bus.InternalCycle();
            return 8;
        ...
        // DI / EI
        t[0xF3] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.SetIme(false);
            return 4;
        };
        t[0xFB] = (ref CpuRegisters r, IInstructionBus bus) =>
        {
            bus.SetIme(true);
            return 4;
        };
