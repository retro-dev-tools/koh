...
public sealed class DataBreakpointInfoResponseBody
{
    ...
    public string[] AccessTypes { get; set; } = new[] { "read", "write", "readWrite" };
...
public sealed class DataBreakpoint
{
    ...
    public string? AccessType { get; set; } // "read" | "write" | "readWrite"
...
public sealed class SetDataBreakpointsArguments
{
    ...
    public DataBreakpoint[] Breakpoints { get; set; } = Array.Empty<DataBreakpoint>();
}
