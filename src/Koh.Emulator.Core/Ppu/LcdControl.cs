...
public static class LcdControl
{
    ...
    public static ushort BgTileMapBase(byte lcdc) =>
        IsSet(lcdc, BgTileMapArea) ? (ushort)0x9C00 : (ushort)0x9800;

    public static ushort WindowTileMapBase(byte lcdc) =>
        IsSet(lcdc, WindowTileMapArea) ? (ushort)0x9C00 : (ushort)0x9800;
