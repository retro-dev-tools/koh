...
namespace Koh.Assembler.Tests.Integration;
...
public class ComplexEndToEndTests
{
    ...
    public async Task Ccode_ConditionCodes_BinaryMatch()
    {
        ...
        await AssertBinaryOutput(
            model,
            Hex("C20000 CA0000 D20000 DA0000" + "20F2 28F0 30EE 38EC" + "C40000 CC0000 D40000")
        );
    }
    ...
    public async Task TrailingCommas_InDataDirectives_BinaryMatch()
    {
        ...
        await AssertBinaryOutput(
            model,
            Hex("01020304050607080009000A000B000C000D000E000F10001112")
        );
    }
