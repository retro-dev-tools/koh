...
1. Add `tests\Emulator\Koh.Compat.Tests\Koh.Compat.Tests.csproj` back to `Koh.Ci.slnf` and
   `tests/Emulator/Koh.Compat.Tests/Koh.Compat.Tests.csproj` to `Koh.slnx`.
2. Add a `ProjectReference` to `src/Emulator/Koh.Boot`, and call
